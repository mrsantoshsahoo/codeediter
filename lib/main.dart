...
//   }
// }
// print("position ${(widget.box).position}");
// print("left line position ${(widget.box).position.dx}");
// print("right line position ${widget.box.position.dx + widget.box.width}");
// print("top line position ${(widget.box).position.dy}");
// print("button line position ${widget.box.position.dy + widget.box.height}");
// final centerX = widget.box.position.dx + (widget.box.width / 2);
// final centerY = widget.box.position.dy + (widget.box.height / 2);
// print("Center position: ($centerX, $centerY)");
// final leftLineX = widget.box.position.dx;
// final topLineY = widget.box.position.dy;
// final bottomLineY = widget.box.position.dy + widget.box.height;
// print(
//     "Left line position: X = $leftLineX, Y from $topLineY to $bottomLineY");
// print("position ${(widget.box).position}");
// print("left line position ${(widget.box).position.dx}");
// print("right line position ${widget.box.position.dx + widget.box.width}");
// print("top line position ${(widget.box).position.dy}");
