...
import 'package:codeediter/src/controllers/drawables/sized2ddrawable.dart';
import 'package:codeediter/src/controllers/events/events.dart';
import 'package:codeediter/src/controllers/events/selected_object_drawable_removed_event.dart';
import 'package:codeediter/src/controllers/helpers/border_box_shadow.dart';
import 'package:codeediter/src/controllers/notifications/notifications.dart';
...
class _ObjectControlBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeColor = this.activeColor ?? theme?.canvasColor ?? Colors.blue;
